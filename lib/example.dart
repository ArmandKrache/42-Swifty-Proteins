...
@RoutePage()
class WebGlCameraView extends StatefulWidget {
  final String fileName;

  const WebGlCameraView({Key? key, required this.fileName}) : super(key: key);

  @override
  State<WebGlCameraView> createState() => _MyAppState();
}

class _MyAppState extends State<WebGlCameraView> {
